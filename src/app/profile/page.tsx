...
export default function Profile() {
  return (
    <div className={`${inter.className} bg-base-200 flex flex-col items-center min-h-screen`}>
      {/* <Header /> */}
      <ProfileCard className="mt-8 md:h-[32rem] w-11/12 h-fit bg-base-100" userFullName={userMock.fullName} userTitle={userMock.title} userImage={userMock.image} bio={userMock.bio} />
